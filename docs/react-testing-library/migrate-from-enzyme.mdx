...
about them on [queries](docs/queries/byrole) documentation page. One of the
...
those who are using screen readers. The
[`ByRole` queries documentation](/docs/queries/byrole) might help you to
...
very efficiently. See the [queries documentation](/docs/queries/about) in
detail.
